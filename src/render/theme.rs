    ...
    pub fn new(name: ThemeName, color: bool, unicode: bool) -> Self {
        ...
        match name {
            ...
            ThemeName::Dark => Self {
                ...
                color,
                unicode,
                text: Color::Rgb(229, 232, 224),
                dim: Color::Rgb(137, 151, 150),
                border: Color::Rgb(54, 69, 68),
                border_focus: Color::Rgb(141, 232, 196),
                accent: Color::Rgb(103, 214, 174),
                success: Color::Rgb(117, 220, 157),
                warning: Color::Rgb(239, 177, 92),
            ...
            ThemeName::Light => Self {
                ...
                color,
                unicode,
                text: Color::Rgb(34, 45, 45),
                dim: Color::Rgb(90, 107, 106),
                border: Color::Rgb(183, 198, 197),
                border_focus: Color::Rgb(20, 128, 105),
                accent: Color::Rgb(20, 128, 105),
                success: Color::Rgb(31, 137, 82),
                warning: Color::Rgb(166, 105, 20),
